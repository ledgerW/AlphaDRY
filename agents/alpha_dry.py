...
def search_web(query: str) -> List[dict]:
    """Search the Web. Useful for when you need recent information about anything or if you don't have a specific source in mind."""
...
def supervisor_agent(state: GraphState) -> GraphState:
    ...
    ## All Tools
    tools = [search_web, JudgeStatement]
